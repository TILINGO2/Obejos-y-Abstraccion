...
public class FrmFacturar extends JInternalFrame {
	...
	public FrmFacturar() {
		...
		btnSeleccionarCliente.setBackground(new Color(220, 220, 220));
		...
		btnEliminarProducto.setBackground(new Color(220, 220, 220));
		getContentPane().add(btnEliminarProducto);
		
		JButton btnAgregarProductos = new JButton("Buscar Producto");
		...
		btnAgregarProductos.setBackground(new Color(220, 220, 220));
		...
		getContentPane().add(btnNuevo);
		 ...
		 btnGenerarFactura = new JButton("Imprimir Factura");
	        btnGenerarFactura.addActionListener(new ActionListener() {
	            public void actionPerformed(ActionEvent e) {
	                generarFactura();
	            }
	        });
	        btnGenerarFactura.setBounds(105, 435, 145, 23);
	        btnGenerarFactura.setBackground(new Color(220, 220, 220));
	...
	private void generarFactura() {
	    ...
	    lblTotal.setText("Valor Total: " + String.format("%.2f", total));
	}
